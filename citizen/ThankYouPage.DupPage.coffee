class window.ThankYouPage extends DupPage
  ...
  inherited:
    title: "Citizen Watch Report Submitted"
    content: [
      """
      <h2>Your cooperation has been noted</h2>
      <p>
    ...
    ,
      ...
      individual, and will use that information to better monitor your
      activities so we can keep you safe.
      </p>
      <p>
      If a Dept. of Unified Protection agent contacts you with questions in the
